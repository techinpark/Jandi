...
enum Localized {
    ...
    static let streakFirstStage = NSLocalizedString("streak_first_stage", comment: "streak stage 1")
    ...
    static let streakFourthStage = NSLocalizedString("streak_fourth_stage", comment: "streak stage 4")
