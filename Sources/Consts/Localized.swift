...
enum Localized {
    ...
    static let streakFirstStage = NSLocalizedString("streakFirstStage", comment: "streak stage 1")
    static let streakSecondStage = NSLocalizedString("streakSecondStage", comment: "streak stage 2")
    static let streakThirdStage = NSLocalizedString("streakThirdStage", comment: "streak stage 3")
    static let streakFourthStage = NSLocalizedString("streakFourthStage", comment: "streak stage 4")
